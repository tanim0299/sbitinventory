        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('category.index_title')</h4>
                    ...
                    <div class="tab-content">
                        ...
                        $onlyTrashed = product_category::leftjoin('product_items','product_items.item_id','product_categories.cat_item_id')
                                       ->select('product_items.item_name_en','product_items.item_name_bn','product_categories.*')
                                    ->onlyTrashed()
                                    ->get();
                        @endphp
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$v->cat_id}}</td>
                                        <td>
                                            <b>{{$v->item_name_en}}</b><br>
                                            <span>{{$v->item_name_bn}}</span><br>
                                        </td>
                                        <td>
                                            <b>{{$v->cat_name_en}}</b><br>
                                            <span>{{$v->cat_name_bn}}</span><br>
                                        </td>
                                        <td>
                                            <a href="{{url('retrive_category')}}/{{$v->cat_id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('catper_delete')}}/{{$v->cat_id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
