        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('measurement.index_title')</h4>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="roles-tab-all">
                            <table id="datatable-roles-all" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>@lang('measurement.sl')</th>
                                        <th>@lang('measurement.name')</th>
                        ...
                        $onlyTrashed = product_measurement::onlyTrashed()->get();
                        @endphp
                        ...
                        <div class="tab-pane" id="roles-tab-deleted">
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$v->measurement_id}}</td>
                                        <td>
                                            <b>{{$v->measurement_unit}}</b><br>
                                        </td>
                                        <td>
                                            <a href="{{url('retrive_measurement')}}/{{$v->measurement_id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('measurementper_delete')}}/{{$v->measurement_id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
