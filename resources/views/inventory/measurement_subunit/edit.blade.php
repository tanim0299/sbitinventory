	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post" class="btn-submit" action="{{ route('measurement_subunit.update',$data->id) }}">
					@csrf
                    @method('PUT')
					...
					<div class="row myinput">
						...
						<div class="form-group col-md-6 mb-2">
							...
							<div class="input-group">
								...
								<select class="form-control" name="measurement_unit_id" id="measurement_unit_id" required>
                                    ...
                                    <option @if($data->measurement_unit_id == $v->measurement_id) selected @endif value="{{$v->measurement_id}}">{{$v->measurement_unit}}</option>
                                    @endforeach
                                    @endif
                                </select>
							</div>
						...
						<div class="form-group col-md-6 mb-2">
							...
							<div class="input-group">
								...
								<input required="Give Measurement" class="form-control" type="text" name="sub_unit_name" id="sub_unit_name" placeholder="@lang('measurement_subunit.name')" value="{{$data->sub_unit_name}}">
							</div>
						</div>
						...
						<div class="form-group col-md-6 mb-2">
							...
							<div class="input-group">
								...
								<input required="Give Measurement" class="form-control" type="text" name="sub_unit_data" id="sub_unit_data" placeholder="@lang('measurement_subunit.data')" value="{{$data->sub_unit_data}}">
							</div>
						</div>
