...
<div class="container">
    ...
    @component('components.breadcrumb')
        @slot('title')
            @lang('measurement_subunit.index_title')
        @endslot
        @slot('breadcrumb1')
        ...
        @if (\App\Traits\RolePermissionTrait::checkRoleHasPermission('role', 'create'))
            ...
            @slot('action_button1_link')
                {{ route('measurement_subunit.create') }}
            @endslot
        @endif
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('measurement_subunit.index_title')</h4>
                    ...
                    <div class="tab-content">
                            ...
                            <table id="datatable-roles-all" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('measurement_subunit.name')</th>
                                        <th>@lang('measurement_subunit.data')</th>
                        ...
                        $onlyTrashed = measurement_subunit::leftjoin('product_measurements','product_measurements.measurement_id','measurement_subunits.measurement_unit_id')
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b>{{$v->sub_unit_name}}</b><br>
                                        </td>
                                        <td>
                                            <b>{{$v->sub_unit_data}}</b><br>
                                        </td>
                                        <td>
                                            <a href="{{url('retrive_subunit')}}/{{$v->id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('subunit_per_delete')}}/{{$v->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
    ...
    <script type="text/javascript">
        $(function () {
          var table = $('#datatable-roles-all').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ route('measurement_subunit.index') }}",
              columns: [
