        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('item.index_title')</h4>
                    ...
                    <div class="tab-content">
                        ...
                        $onlyTrashed = product_item::onlyTrashed()->get();
                        @endphp
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('retrive_item')}}/{{$v->item_id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('itemper_delete')}}/{{$v->item_id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
