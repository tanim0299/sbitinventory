...
<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar="">
        ...
        <ul class="side-nav">
            ...
            {{-- <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarDashboardsMenu" aria-expanded="false" aria-controls="sidebarDashboardsMenu" class="side-nav-link">
    ...
    <a href="{{ $menu_element['menu_link'] ?? '#sidebarToggle'.$key}}" @if (!$menu_element['menu_link']) data-bs-toggle="collapse" aria-expanded="false" aria-controls="sidebarToggle{{$key}}" @endif class="side-nav-link waves-effect waves-dark">
        <i class="{{ $menu_element['menu_icon'] }}"></i>
        <span>{!!\App\Helpers\MenuHelper::menuName($menu)!!}</span>
        @if (count($menu->children) > 0) <span class="menu-arrow"></span> @endif
    </a>
    --}}{{-- 1st child start --}}{{--
                        @if (count($menu->children) > 0)
                            <div id="sidebarToggle{{$key}}">
    <ul class="side-nav-second-level">
        @foreach ($menu->children as $sub_menu)
        @php
        $menu_element = App\Helpers\MenuHelper::MenuElement($sub_menu,request()->segment(1));
        @endphp

        @if (@$role->hasPermissionTo($sub_menu->name . ' List'))
        <li class="side-nav-item {{ $menu_element['active_class'] }}">
            <a href="{{ $menu_element['menu_link'] ?? '#sidebarToggle'.$key}}" @if (!$menu_element['menu_link']) data-bs-toggle="collapse" aria-expanded="false" aria-controls="sidebarToggle{{$key}}" @endif class="side-nav-link waves-effect waves-dark">
                <i class="{{ $menu_element['menu_icon'] }}"></i>
                <span>{!!\App\Helpers\MenuHelper::menuName($sub_menu)!!}</span>
                @if (count($sub_menu->children) > 0) <span class="menu-arrow"></span> @endif
            </a>
        </li>
        @endif
        @endforeach
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEcommerce">
                    <ul class="side-nav-second-level">
                        ...
                        <li>
                            <a href="apps-ecommerce-products-details.html">Products Details Products Details</a>
                        </li>
                        <li>
