...
<div class="container px-lg-5">
    <div class="row ">
                ...
                <form method="POST" id="form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <button class="btn btn-primary w-100 py-3" type="" id="loading">.....</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="member-single-card">
                <b>{{$v->member_name}}</b><br>
                <small>{{$v->designation}}</small><br>
                <small>Phone : {{$v->phone}}</small><br>
                <small>E-mail : {{$v->email}}</small>
            </div>
            @endforeach
            @endif
            <div class="member-single-card">
                <b>{{$wb_content->company_name}}</b><br>
                <small>Phone : {{$wb_content->phone1}}</small><br>
                <small>E-mail : {{$wb_content->email}}</small>
            </div>
        </div>
    </div>
</div>
